#' Return n-largest value of a vector of numbers
#' 
#' @author Niklas Roming
#' @param x A vector (numeric or integer)
#' @param n Which value to return (e.g. n=2 => second-largest)
#' @return The n-largest value of x
#' @export
LargeNR <- function(x, n){
  ...
  y <- unlist(sort(x, decreasing = TRUE)[n])
  return(y)
}